...
- **SC-007**: A reviewer browsing the project's decision records can find one record per major design choice (architecture style, vector store, parsers, provider strategy, streaming approach, client tech stack, backend language/framework), each with context / decision / alternatives / consequences clearly separated.
